      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {items.map((project, index) => (
            ...
            <div 
              key={index} 
              className="group rounded-2xl overflow-hidden bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 hover:border-neon/50 transition-all duration-300 hover:shadow-xl dark:hover:shadow-none cursor-pointer"
            >
              <a href={`${projectBaseHref}/${project.slug}`}>
